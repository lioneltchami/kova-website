...
import * as __fd_glob_21 from "../content/docs/guides/webhook-notifications.mdx?collection=docs"
import * as __fd_glob_20 from "../content/docs/guides/token-tracking.mdx?collection=docs"
import * as __fd_glob_19 from "../content/docs/guides/plan-templates.mdx?collection=docs"
import * as __fd_glob_18 from "../content/docs/guides/model-tiering.mdx?collection=docs"
import * as __fd_glob_17 from "../content/docs/guides/interactive-mode.mdx?collection=docs"
import * as __fd_glob_16 from "../content/docs/guides/github-integration.mdx?collection=docs"
import * as __fd_glob_15 from "../content/docs/guides/cross-platform.mdx?collection=docs"
import * as __fd_glob_14 from "../content/docs/guides/checkpoint-recovery.mdx?collection=docs"
...
export const docs = await create.doc("docs", "content/docs", {"index.mdx": __fd_glob_0, "commands/build.mdx": __fd_glob_1, "commands/completions.mdx": __fd_glob_2, "commands/config.mdx": __fd_glob_3, "commands/init.mdx": __fd_glob_4, "commands/plan.mdx": __fd_glob_5, "commands/pr.mdx": __fd_glob_6, "commands/run.mdx": __fd_glob_7, "commands/status.mdx": __fd_glob_8, "commands/team-build.mdx": __fd_glob_9, "commands/update.mdx": __fd_glob_10, "getting-started/configuration.mdx": __fd_glob_11, "getting-started/installation.mdx": __fd_glob_12, "getting-started/quickstart.mdx": __fd_glob_13, "guides/checkpoint-recovery.mdx": __fd_glob_14, "guides/cross-platform.mdx": __fd_glob_15, "guides/github-integration.mdx": __fd_glob_16, "guides/interactive-mode.mdx": __fd_glob_17, "guides/model-tiering.mdx": __fd_glob_18, "guides/plan-templates.mdx": __fd_glob_19, "guides/token-tracking.mdx": __fd_glob_20, "guides/webhook-notifications.mdx": __fd_glob_21, "reference/agent-types.mdx": __fd_glob_22, "reference/checkpoint-format.mdx": __fd_glob_23, "reference/kova-yaml.mdx": __fd_glob_24, "reference/plan-format.mdx": __fd_glob_25, });
