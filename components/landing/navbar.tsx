...
export function Navbar() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md bg-white/80 dark:bg-kova-charcoal/80 border-b border-gray-200 dark:border-kova-border">
      ...
      {mobileMenuOpen && (
        <div className="sm:hidden bg-white/95 dark:bg-kova-charcoal/95 backdrop-blur-md border-b border-gray-200 dark:border-kova-border px-4 py-4 space-y-3">
          <a
            href="/docs"
