        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
          {testimonials.map((testimonial, i) => (
            <motion.div
              ...
              className="flex flex-col gap-4 rounded-2xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-[#1A1A2E] p-6"
            >
              <p className="flex-1 text-sm leading-relaxed text-gray-700 dark:text-[#C0C0C8]">
              ...
              <div className="border-t border-gray-200 dark:border-white/10 pt-4">
                ...
                <p className="mt-0.5 text-xs text-gray-500 dark:text-[#C0C0C8]/60">
